    ...
    e.extend(y, {
        ...
        H: function(d) {
            ...
            if (a) {
                ...
                a.c.innerzoommagnifier && (c.a.p += (c.a.g - c.a.p) / a.c.loopspeedanimate,
        ...
        I: function(d) {
            var c = this
              , a = d.data("specs");
            a && (a.h += (a.k - a.h) / a.c.zoomspeedanimate,
        ...
        P: function(d) {
            ...
            var p = a.c.magnifiersize[1], s, l = a.r.offsetsl(), h = 0, b = 0;
            ...
            a.c.descarea && (h = e(a.c.descarea).offsetsl().left,
            b = e(a.c.descarea).offsetsl().top);
            a.c.innerzoommagnifier && (h = this.a.g - Math.round(a.e.b / 2),
        ...
        F: function(d, c, a) {
            ...
            var b = e.extend({}, this.dsetting, c), x = b.zindex || this.T(d), m = {
                b: d.width(),
                d: d.height()
            }, p = new p, y = d.attr("data-title") ? d.attr("data-title") : "", E = d.attr("data-help") ? d.attr("data-help") : "", C = d.attr("data-text-bottom") ? d.attr("data-text-bottom") : "", f = this, B, v, u, q, n, g, t;
            if (0 === m.d || 0 === m.b)
                e(new Image).on('load', function() {
                    f.F(d, c)
                }).attr("src", d.attr("src"));
                ...
                for (v in b)
                    "" === b[v] && (b[v] = this.dsetting[v]);
                B = b.zoomrange[0] < b.zoomstart ? b.zoomstart : b.zoomrange[0];
                if ("0,0" === b.magnifiersize.toString() || "" === b.magnifiersize.toString())
                    b.magnifiersize = b.innerzoommagnifier ? [m.b / 2, m.d / 2] : [m.b, m.d];
                ...
                b.innerzoom && (b.magnifiersize = [m.b, m.d],
                ...
                var A = "onwheel"in document || 9 <= document.documentMode ? ["wheel"] : ["mousewheel", "DomMouseScroll", "MozMousePixelScroll"], z, w;
                if (e.event.fixHooks)
                ...
                e(document).mousemove(function(a) {
                    f.a.D = a.pageX;
                    f.a.g !== f.a.D && (clearTimeout(f.a.n),
                    clearTimeout(f.a.o),
                    d.css({
                        visibility: "visible"
                    }))
                ...
                g.mouseover(function(a) {
                    ...
                    clearTimeout(f.a.n);
                    clearTimeout(f.a.o);
                    b.j !== g.data("largeimage") && (e(new Image).on('load', function() {}).attr("src", b.j),
                    e(g).unbind(),
                    e(n).remove(),
                    e(q).remove(),
                    e(u).remove(),
